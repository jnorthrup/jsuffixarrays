...
import org.jsuffixarrays.Tools.assertAlways
...
class DivSufSort : ISuffixArrayBuilder {
    ...
    override fun buildSuffixArray(input: IntArray?, start: Int, length: Int): IntArray {
        ...
        val mm = Tools.minmax(input!!, start, length)
     ...
     * Returns the median of five elements.
     */
    private fun trMedian5(ISAd: Int, v1: Int, v2: Int, v3: Int, v4: Int, v5: Int): Int {
        var v1 = v1
        var v2 = v2
        var v3 = v3
        var v4 = v4
     ...
     * Returns the median of three elements.
     */
    private fun trMedian3(ISAd: Int, v1: Int, v2: Int, v3: Int): Int {
        var v1 = v1
        var v2 = v2
        ...
        return if (SA!![ISAd + SA!![v2]] > SA!![ISAd + SA!![v3]]) {
            if (SA!![ISAd + SA!![v1]] > SA!![ISAd + SA!![v3]]) {
                v1
            } else {
                v3
